...
device = "cpu"
pretrained_model = "/home/ubuntu/birdring/SSAP/ckpt/final_title"
...
weights_path = '/home/ubuntu/birdring/SSAP/PPLM/ckpt/SST_classifier_head_epoch_85.pt'
meta_path = '/home/ubuntu/birdring/SSAP/PPLM/ckpt/SST_classifier_head_meta.json'
...
def predict(input_sentence, model, classes, cached=False, device='cpu'):
    ...
    #log_probs = model(input_t).data.cuda().numpy().flatten().tolist()
...
i = 0
file_data = ""
#with open("/home/ubuntu/birdring/SSAP/PPLM/sample_pplm_0429_2.txt", "r", encoding="utf-8") as f:
with open("/home/ubuntu/birdring/SSAP/result/final/pplm_0524.txt", "r", encoding="utf-8") as f:
#with open("../sample_5.txt", "r", encoding="utf-8") as f:
    for line in f:
        line = line.rstrip()
        #line = line.replace('.', ' .')
        line = line.replace('\t', ' ')
        if(len(line) <= 1):  line = 'ok'
        else : result = predict(line, discriminator, idx2class, cached=False, device=device)
        #print(line)
        i += 1
        print(i, result[0], result[1])
        file_data = file_data + result[0] + '\n'

with open("/home/ubuntu/birdring/SSAP/result/sentiment_eval/ending_pplm0524.txt","w",encoding="utf-8") as f:
