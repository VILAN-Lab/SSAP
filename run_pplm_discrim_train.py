...
def train_discriminator(
    ...
    add_eos_token = pretrained_model.startswith("../ckpt/final_title")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_model", type=str, default="../ckpt/final_title",
    ...
    parser.add_argument("--save_model", action="store_true", default='./save/',
                        help="whether to save the model")
    parser.add_argument("--cached", action="store_true",
                        help="whether to cache the input representations")
    parser.add_argument("--no_cuda", action="store_true",
                        help="use to turn off cuda")
    parser.add_argument("--output_fp", default="./ckpt/",
